...
cobia database_trypsin -f "$DIR"Human_uniprot_09082016_all.fasta -n "$DIR"Human_uniprot_09082016_all_trypsin.txt -c no-write
...
RTPredict -in_text "$DIR"Human_uniprot_09082016_all_trypsin.txt -out_text:file "$DIR"Human_uniprot_09082016_rt_oligo.csv -svm_model "$DIR"prostate_cancer_model_oligo.txt -total_gradient_time 7200
