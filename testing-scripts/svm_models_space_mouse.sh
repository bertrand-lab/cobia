...
cobia database_trypsin -f "$DIR"UP000000589_10090.fasta -n "$DIR"UP000000589_10090_trypsin.txt -c no-write
...
RTPredict -in_text "$DIR"UP000000589_10090_trypsin.txt -out_text:file "$DIR"UP000000589_10090_rt_oligo.csv -svm_model "$DIR"space_mouse_model_oligo.txt -total_gradient_time 9300
