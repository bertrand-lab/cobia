...
cobia database_trypsin -f "$DIR"combined_metagenomic_aylward_single.fasta -n "$DIR"combined_metagenomic_aylward_trypsin_single.txt
...
RTPredict -in_text "$DIR"combined_metagenomic_aylward_trypsin_single.txt -out_text:file "$DIR"aylward_tryptic_peptide_rt_oligo.csv -svm_model "$DIR"aylward_model_oligo.txt -total_gradient_time $retention_time &
RTPredict -in_text "$DIR"combined_metagenomic_aylward_trypsin_single.txt -out_text:file "$DIR"aylward_tryptic_peptide_rt_linear.csv -svm_model "$DIR"aylward_model_linear.txt -total_gradient_time $retention_time &
RTPredict -in_text "$DIR"combined_metagenomic_aylward_trypsin_single.txt -out_text:file "$DIR"aylward_tryptic_peptide_rt_rbf.csv -svm_model "$DIR"aylward_model_rbf.txt -total_gradient_time $retention_time &
RTPredict -in_text "$DIR"combined_metagenomic_aylward_trypsin_single.txt -out_text:file "$DIR"aylward_tryptic_peptide_rt_poly.csv -svm_model "$DIR"aylward_model_poly.txt -total_gradient_time $retention_time &
